...
<table class="data_pegawai">
    ...
    <tr>
        ...
        <td style="width: 45%;">&nbsp;<?php echo $tampil['nama']; ?></td>
        <td style="width: 15%;">&nbsp;NIP</td>
        <td style="width: 25%;">&nbsp; <?php echo $tampil['nip']; ?></td>
    </tr>
    ...
    <tr>
        ...
        <td>&nbsp;MASA KERJA</td>
        <td>&nbsp;<?php echo $tampil['masakerja']; ?></td>
    </tr>
...
<table class="alasan_cuti">
    ...
    <tr>
        <td class="ac_td"><?php echo $tampil['alasan']; ?></td>
    </tr>
</table>
<br>
...
<table class="lama_cuti">
    ...
    <tr>
        ...
        <td style="text-align: center; width: 20%;"><?php echo $tampil['lamacuti']; ?>(Hari<del>/Bulan/Tahun</del>)&#42;</td>
...
<table class="ca_cuti">
    ...
    <tr>
        <td style="text-align: center;"><?php echo $tahun1sisa; ?></td>
        <td style="text-align: center;"></td>
        <td>&nbsp;</td>
        <td rowspan="3"></td>
        <td>&nbsp;4. CUTI MELAHIRKAN</td>
    ...
    <tr>
        <td style="text-align: center;"><?php echo $tahun2sisa; ?></td>
        <td style="text-align: center;"></td>
        <td>&nbsp;</td>
        <td>&nbsp;5. CUTI KARENA ALASAN PENTING</td>
        <td></td>
    ...
    <tr>
        <td style="text-align: center;"><?php echo $tahun3sisa; ?></td>
        <td style="text-align: center;"></td>
        <td>&nbsp;</td>
        <td>&nbsp;6. CUTI DILUAR TANGGUNGAN NEGARA</td>
        <td></td>
...
<table class="alamat_cuti">
    ...
    <tr>
        <td style="width: 50%;" rowspan="2"><?php echo $tampil['alct']; ?></td>
        <td style="text-align: center; width: 10%;">Telp.</td>
        <td style="width: 40%;">&nbsp;<?php echo $tampil['notelp']; ?></td>
    </tr>

    <tr>
        <td style="text-align: center;" colspan="2">Hormat saya, <br> <br> <br> <br> <?php echo $tampil['nama']; ?> <br> <?php echo $tampil['nip']; ?> </td>
    </tr>
...
<table class="atasan_langsung">
    ...
    <tr>
        ...
        <td class="al1"></td>
        <td class="al2"></td>
        <td style="text-align: center;  "> <br> <br> <br> <br> Kasubag Bagian <br> <?php echo $tampil['nama_penyetuju']; ?></td>
    </tr>
    ...
    <tr>
        ...
        <td class="al1"></td>
        <td class="al2"></td>
        <td style="text-align: center; border-top: hidden; "><?php echo $tampil['nip_penyetuju']; ?></td>
    </tr>
...
<table class="keputusan_pejabat">
    ...
    <tr>
        ...
        <td class="al1"></td>
        <td class="al2"></td>
        <td style="padding-bottom: 10px; text-align: center;  ">KETUA PENGADILAN MARTAPURA<br> <br> <br> <br> <br> Ketua <br> <?php echo $tampil['nama_ketua']; ?>
             <br><?php echo $tampil['nip_ketua']; ?></td>
    </tr>
</table>

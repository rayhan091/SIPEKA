            ...
            <form action="surat.php" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="lamacuti" class="form-control">
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="thn1" class="form-control" value="<?php echo $tahun1sisa; ?>" >
                    </div>

                    <div class="form-group mb-2">
                        <label for="">TAHUN2</label>
                        <input type="text" name="thn2" class="form-control" value="<?php echo $tahun2sisa; ?>" >
                    </div>

                    <div class="form-group mb-2">
                        <label for="">TAHUN3</label>
                        <input type="text" name="thn3" class="form-control" value="<?php echo $tahun3sisa; ?>" >
                    </div>
                    ...
                    <div class="form-group mb-2">
                        <label for="">Alamat Selama Menjalankan Cuti</label>
                        <textarea name="alct" class="form-control" rows="3"></textarea>
                    </div>
